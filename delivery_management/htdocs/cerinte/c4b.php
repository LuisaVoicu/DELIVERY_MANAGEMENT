...
<nav class="navbar navbar-expand-lg bg-light">
        ...
        <h1 style = "color: black">Cerinta 4 b</h1>
        ...
        <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" aria-expanded="false" aria-controls="collapseWidthExample">
            ...
            <div class="collapse collapse-horizontal" id="collapseWidthExample" style="min-height: 120px; color: black;">
                <div class="card card-body" style="width: 300px;">
                11.04. Să se exprime în SQL următoarele interogări folosind operatorul JOIN:
                b) Să se găsească perechile de coduri de proiecte (idp1, idp2), cu condiția ca ambelor proiecte să le fie livrată aceeași piesă în aceeași cantitate și aceeași unitate de măsură de furnizori diferiți. O pereche este unică în rezultat.                </div>
            </div>
