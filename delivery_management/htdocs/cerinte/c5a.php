...
<nav class="navbar navbar-expand-lg bg-light">
        ...
        <h1 style = "color: black">Cerinta 5 a</h1>
        ...
        <div style="min-height: 120px; color: black;">
            <div class="collapse collapse-horizontal" id="collapseWidthExample">
                ...
                a) Să se găsească numele componentei livrată în cantitatea cea mai mare pentru proiecte situate în același oraș cu orașul componentei.
