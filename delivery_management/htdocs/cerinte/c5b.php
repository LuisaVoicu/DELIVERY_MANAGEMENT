...
<nav class="navbar navbar-expand-lg bg-light">
        ...
        <h1 style = "color: black">Cerinta 5 b</h1>
        ...
        <div style="min-height: 120px; color: black;">
            <div class="collapse collapse-horizontal" id="collapseWidthExample">
                ...
                b) Să se găsească numele proiectului pentru care sunt livrate componente de culoare X.
            </div>
        </div>
        ...
        <input type = "text" name="color" placeholder="Introduceti culoarea" value="">
