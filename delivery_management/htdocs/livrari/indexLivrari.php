...
<nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="container p-5 my-5 bg-light text-white"> 
        ...
        <div >
                <h1 style = "color: black">Lista Componente</h1>
                <a class="btn btn-primary" href ="/livrari/createLivrari.php" role="button" >Adauga Componenta</a>
        </div>
        <br>
        <table class="table">
            <thread>
                ...
                <tbody>
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        <td>$row[um]</td>
                        <td>
                        <a class='btn btn-primary btn-sm' href='/livrari/editLivrari.php?IDF=$row[IDF] && IDP=$row[IDP] && IDC=$row[IDC]'>Edit</a>
                        <a class='btn btn-danger btn-sm'href = '/livrari/deleteLivrari.php?IDF=$row[IDF] && IDP=$row[IDP] && IDC=$row[IDC]'>Delete</a>
                        </td>
                        ";
