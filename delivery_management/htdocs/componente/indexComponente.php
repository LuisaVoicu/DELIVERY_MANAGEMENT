...
<nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="container p-5 my-5 bg-light text-white"> 
        ...
        <div >
                ...
                <a class="btn btn-primary" href ="/componente/createComponente.php" role="button" >Adauga Componenta</a>
        </div>
            ...
            <thread>
                ...
                <tbody>
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        <td>$row[ORAS]</td>
                        <td>
                        <a class='btn btn-primary btn-sm' href='/componente/editComponente.php?IDC=$row[IDC]'>Edit</a>
                        <a class='btn btn-danger btn-sm'href = '/componente/deleteComponente.php?IDC=$row[IDC]'>Delete</a>
                        </td>
                        ";
