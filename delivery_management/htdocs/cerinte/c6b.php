...
<nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="container p-5 my-5 bg-light text-white"> 
        <h1 style = "color: black">Cerinta 6 b</h1>
        ...
        <div style="min-height: 120px; color: black;">
            <div class="collapse collapse-horizontal" id="collapseWidthExample">
                ...
                b) Să se găsească pentru componenta cu codul ’C1’ cantitatea minimă, cantitatea medie și cantitatea maximă livrată de furnizori funcție de unitatea de măsură, indiferent de proiect. (um, minim, mediu, maxim)
                </div>
        </div>


        <form action="" method="POST">
        <input type = "text" name="id_c" placeholder="Introduceti IDC-ul" value="">
        <input type ="submit" name="submit" value="Submit">
        <!--<input class="form-control mr-sm-2" type="search" name="color" placeholder="Search" aria-label="Search">
