...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container p-5 my-5 bg-light text-white"> 
        ...
        <div >
                <h1 style = "color: black">Lista Furnizori</h1>
                <a class="btn btn-primary" href ="/furnizori/createFurnizori.php" role="button" >Adauga Furnizor</a>
        </div>
        <br>
        <table class="table">
            <thread>
                ...
                <tbody>
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        <td>$row[ORAS]</td>
                        <td>
                        <a class='btn btn-primary btn-sm' href='/furnizori/editFurnizori.php?IDF=$row[IDF]'>Edit</a>
                        <a class='btn btn-danger btn-sm'href = '/furnizori/deleteFurnizori.php?IDF=$row[IDF]'>Delete</a>
                        </td>
                        ";
