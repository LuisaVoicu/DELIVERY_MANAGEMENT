...
<nav class="navbar navbar-expand-lg bg-light">
        ...
        <h1 style = "color: black">Cerinta 6 a</h1>
        ...
        <div style="min-height: 120px; color: black;">
            <div class="collapse collapse-horizontal" id="collapseWidthExample">
                ...
                a) Să se găsească pentru fiecare proiect cantitatea totală livrată indiferent de furnizor pentru fiecare piesă și unitate de măsură. (proiect, piesa, um, cantitate_totala)
            </div>
        </div>
