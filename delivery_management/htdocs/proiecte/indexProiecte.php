...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container p-5 my-5 bg-light text-white"> 
        ...
        <div >
            ...
            <a class="btn btn-primary" href ="/proiecte/createProiecte.php" role="button">Adauga Proiect</a>
        </div>
        <br>
        <table class="table">
            <thread>
                ...
                <tbody>
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        <td>$row[ORAS]</td>
                        <td>
                        <a class='btn btn-primary btn-sm' href='/proiecte/editProiecte.php?IDP=$row[IDP]'>Edit</a>
                        <a class='btn btn-danger btn-sm'href = '/proiecte/deleteProiecte.php?IDP=$row[IDP]'>Delete</a>
                        </td>
                        ";
